...
if __name__ == "__main__":
    ...
    #initialize scraper
    twitter_columns = pickle.load(open(os.path.join(path, 'data/twitter_columns.p'),"rb"))
    ...
    if args.what == 'gov' or args.what == 'both':
        ...
        #government
        gov_ids = pickle.load(open(os.path.join(path, "data/sample/gov_sample.p"),"rb"))
    ...
    if args.what == 'opp' or args.what == 'both':
        ...
        #opposition:
        opp_ids = pickle.load(open(os.path.join(path, "data/sample/opp_sample.p"),"rb"))
